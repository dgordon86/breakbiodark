            ...
            if (have_posts()):
                ...
                <div class="list-post-cat">                    
                    ...
                    while (have_posts()) : the_post();
                        ...
                        if (0 == $loop_index) {
                            $post_classes[] = 'first-item';
                            printf('<div class="%s">', implode(' ', get_post_class($post_classes)));
                        } else {
                            if (1 == $loop_index) {
                                echo '<ul class="list-post-cat-item list-unstyled">';
                            }
                            printf('<li class="%s">', implode(' ', get_post_class($post_classes)));
                        }
                        ?>
